...
public final class ViewTaskLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private ViewTaskLayoutBinding(@NonNull MaterialCardView rootView, @NonNull TextView dateTxt,
  ...
  @NonNull
  public static ViewTaskLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ViewTaskLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.view_task_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ViewTaskLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ViewTaskLayoutBinding((MaterialCardView) rootView, dateTxt, deleteImg, descrTxt,
          editDeleteL, editImg, titleTxt);
    }
